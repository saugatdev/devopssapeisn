...
describe('Attendance Testing', () => {
    ...
    beforeAll(async()=>{
      ...
      console.log("-------------------This is the Attendance Testing-------------------------")
  ...
  const createEmployee = await axios.post(`${BACKEND_URL}/superadmin/createemployee`,
    ...
    const employeeLogin = await axios.post(`${BACKEND_URL}/employee/login`,{
      ...
      test("should be able to get attendance summary",async()=>{
        ...
        const attendandeSummaryResponse = await axios.post(`${BACKEND_URL}/employee/getattendancesummary`,{
          employee_id:employeeId
        },{
          headers:{
            Authorization: `Bearer ${usertoken}`
        ...
        expect(attendandeSummaryResponse.status).toBe(200)

        
      })

           
      test("should not be able to get attendance summary without authorization",async()=>{
        ...
        try{
          const attendandeSummaryResponse = await axios.post(`${BACKEND_URL}/employee/getattendancesummary`,{
            ...
            headers:{
              Authorization: `Bearer ${123333}`
            }
          })

          expect(attendandeSummaryResponse.status).not.toBe(200)
      ...
      test("should not be able to get all attendance ",async()=>{

       
        try{
          const getallAttendanceSummary = await axios.post(`${BACKEND_URL}/employee/getallattendance`,{},{
            headers:{
              Authorization: `Bearer ${usertoken}`
            }
          })

          expect(getallAttendanceSummary.status).not.toBe(200)
...
describe('Attendance Testing from the HR', () => {
...
const createEmployee = await axios.post(`${BACKEND_URL}/superadmin/createemployee`,
  ...
  const employeeLogin = await axios.post(`${BACKEND_URL}/employee/login`,{
    ...
    test("should  be able to get all attendance ",async()=>{
        ...
        expect(getallAttendanceSummary.status).toBe(200)
